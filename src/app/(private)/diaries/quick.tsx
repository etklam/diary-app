      ...
      <ScrollView keyboardShouldPersistTaps="handled" contentContainerStyle={styles.content}>
        ...
        {state.ready && <>
          ...
          {more && <>
            ...
            <TextInput accessibilityLabel={t("Diary title")} maxLength={500} editable={!locked} style={styles.input} value={draft.title} onChangeText={title => controller.edit({ title })} />
